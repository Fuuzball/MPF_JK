...
class LBFGS(Optimizer):
    ...
    def step(self, closure):
        ...
        if abs_grad_sum <= tolerance_grad:
            print('abs_grad_sum is less than tolerance before first iteration')
            return loss
        ...
        while n_iter < max_iter:
            ...
            if current_evals >= max_eval:
                logger.info(f'Exit because max_eval ({max_iter}) reached after {n_iter} iterations')
                break
            ...
            if gtd > -tolerance_change:
                logger.info(f'Exit because tolerance_change ({tolerance_change}) reached by gtd after {n_iter} iterations')
                break
